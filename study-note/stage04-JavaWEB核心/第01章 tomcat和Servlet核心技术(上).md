...
```xml
<!-- 在web.xml中的对应的servlet节点下配置ServletConfig初始化参数, 可以有多个参数 -->
<servlet>
...
```xml
<!-- 在web.xml的根节点下配置ServletContext初始化参数, 可以有多个参数-->
<context-param>
...
- `ServletContext`对象的初始化参数可以在`web.xml`文件中设置, 也可以通过`setInitParameter`方法设置; 
