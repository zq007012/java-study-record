...
<div style="width: 600px; margin-left: auto; margin-right: auto">
    ...
    >
        ...
        <div class="form-group">
            ...
            <select id="classGradeId" name="classGradeId" class="form-control                      " required>
                <c:forEach var="cg" items="${cgList}">
                    <option value="${cg.classGradeId}"
                        ${cg.classGradeId.equals(param.classGradeId) ? 'selected' : ''}>
        ...
        <div class="form-group">
            ...
            <div id="gender" class="radio" style="margin-left: 2.5em">
                <label class="radio-inline">
                    ...
                    ${!'女'.equals(param.gender) ? 'checked' : ''}/>
                    男
                </label>
                <label class="radio-inline">
                    <input name="gender" type="radio" value="女"
                    ${'女'.equals(param.gender) ? 'checked' : ''}/> 女
                </label>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input
                    ...
                    type="date"
                    class="form-control"
                    value="${empty param.birthday ? '2005-01-01' : param.birthday}"
                    max="2015-01-01"
                    min="1990-01-01"
            />
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="notes" name="notes"
                      class="form-control">${param.notes}</textarea>
        </div>
