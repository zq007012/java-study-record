            ...
            <form action="${pageContext.request.contextPath}/employee/save"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="empName"
                           name="empName" placeholder="请输入姓名">
                </div>
                <div class="form-group">
                    ...
                    <script>
                        $(function (){
                            $("#dept").empty();
                            $.get(
                                "${pageContext.request.contextPath}/dept/findAll",
                                function (response) {
                                    response.forEach(function (dept) {
                                        let option = $("<option></option>");
                                        option.prop("value", dept.deptId);
                                        option.text("部门: " + dept.deptName + ", 主管: " + dept.majorName);
                                        $("#dept").append(option);
                                    });
                                }
                            );
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="joinDate"
                           name="joinDate" placeholder="请输入加入日期">
                </div>
                <div class="form-group">
